...
if active_section == "🎮 Demo $1,200":
    ...
    st.markdown(
        ...
        "trades this like a REAL account from six live-proven streams "
        "(🌟 EARLY ELITE · 🏆 TOP CONVICTION · 🔮✅ KRONOS APPROVED · "
        ...
        "when several systems agree — 🥇 PRIME and 🚀 MOONSHOT are "
