...
if active_section == "🎮 Demo $1,200":
    ...
    st.markdown(
        ...
        "trades this like a REAL account from seven live-proven streams "
        "(💎 ELITE CONVICTION MAX/HIGH · 🌟 EARLY ELITE · 🏆 TOP "
        "CONVICTION · 🔮✅ KRONOS APPROVED · "
        "🌊 TREND RIDER · 📡 SURGE · 🌱 FRESH): 5 slots max "
        "(quality-gated — an empty slot beats a weak trade) · 2% risk "
        "· taker "
        "fees · one position per coin · bank half at TP1 → breakeven "
        "→ TP2/48h (🌊 rider: 21d hold, 2-slot cap). Ranked by class "
        "weight + confidence + live 14d desk form, with a big bonus "
        "when several systems agree — 💎 ELITE CONVICTION with a 🔮✅ "
        "approval now outranks every other combination on the desk. "
        "A Kronos read flipping against a WORKING trade banks it. "
