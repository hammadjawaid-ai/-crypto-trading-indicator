...
if active_section == "🎮 Demo $1,500":
    ...
    st.markdown(
        ...
        "the 10 seats · the 💎 ELITE FAMILY — raw elite conviction "
        "cream (🚀 approved + MAX grade / 90+ score / 2+ lanes at "
        "85+, max 3 seats) plus 💎✅ CONFIRMED ENTRIES (the "
        "validated pullback+confirm entry) — capped at 4 seats "
        "TOGETHER. Nothing else spends a cent. 10 slots · "
